...
public interface IAssignmentService
{
    ...
    Task<IReadOnlyList<QueueResponse>> ListQueuesAsync(CancellationToken cancellationToken);
    Task<QueuePlacementResult> PlaceInQueueAsync(Guid ticketId, PlaceTicketInQueueRequest request, ClaimsPrincipal actor, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyList<EligibleTechnicianResponse>?> GetEligibleTechniciansAsync(Guid ticketId, ClaimsPrincipal actor, CancellationToken cancellationToken);
