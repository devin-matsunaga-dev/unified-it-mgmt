...
public abstract class ConfigurationItem
{
    ...
    /// <summary>
    /// Generated by Postgres over this CI's identity, its addresses and its description; the GIN index on
    /// it is what makes global search (WP-5.4) find an asset. Never assigned in C# — the database owns it.
    /// <para>
    /// It sits on the base type even though half of what it covers is a derived type's column, because TPH
    /// puts every one of those columns in <c>assets.cis</c> anyway. See
    /// <see cref="ConfigurationItemConfiguration"/> for why that forces the expression to be written out.
    /// </para>
    /// </summary>
