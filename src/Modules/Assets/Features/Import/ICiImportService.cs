...
{
    /// <summary>
    /// Reads the uploaded file's header row and proposes which column feeds which CI field. A null
    /// <paramref name="type"/> is a mixed-type file, whose rows carry their own.
    /// </summary>
