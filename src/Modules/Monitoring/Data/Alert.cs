...
public sealed class Alert
{
    ...
    /// <summary>
    /// Generated by Postgres over the summary and the metric name; the GIN index on it is what lets global
    /// search (WP-5.4) find an alert by what it said. The rule id is in it too, because that is the string
    /// an operator copies out of a ticket the automation opened.
    /// </summary>
