...
public sealed class MonitoredDevice
{
    ...
    /// <summary>
    /// Generated by Postgres over the address, the poller group and the notes — everything a device has of
    /// its own. Its name is the CI's and lives in another module's schema, so it is not in here: global
    /// search (WP-5.4) answers about a device by the address it is polled at, the same call WP-5.3 made.
    /// </summary>
